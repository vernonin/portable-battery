module.exports = {
  messages: {
    CN: {
      ...
      afterCreateMenu: '新建菜单成功！',
      afterUpdateMenu: '修改成功！',
      afterEditeRole: '修改成功！',
    ...
    US: {
      ...
      roleCode: 'Role code',
      roleCodepl: 'Please enter role code',
      roleName: 'Role name',
      ...
      menuNumber: 'Menu code',
      menuNumberpl: 'Please enter menu code',
      menuName: 'Menu name',
      ...
      afterCreateMenu: 'New a menu succeeded!',
      afterUpdateMenu: 'Update menu information succeeded!',
